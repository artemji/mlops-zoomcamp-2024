...
from evidently.metrics import ColumnDriftMetric, DatasetDriftMetric, DatasetMissingValuesMetric, ColumnDistributionMetric
...
def calculate_metrics_postgresql(curr, i):
	...
	curr.execute(
		...
		(begin + datetime.timedelta(i), prediction_drift, num_drifted_columns, share_missing_values, fare_amount_quantile_50)
	)
