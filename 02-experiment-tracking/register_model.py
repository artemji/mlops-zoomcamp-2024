...
def run_register_model(data_path: str, top_n: int):
    ...
    # Ensure the best models experiment exists
    ...
    best_run = client.search_runs(
        experiment_ids=best_models_experiment_id,
        run_view_type=ViewType.ACTIVE_ONLY,
        max_results=1,
    ...
    print(f"Model registered as {model_name} with run_id {best_run.info.run_id}")
